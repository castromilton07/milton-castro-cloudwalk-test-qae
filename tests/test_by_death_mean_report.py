...
def test_validate_by_death_report_return_match_number_correctly(dict):
    report = ByDeathMeanReport.generate(dict)
    expected = " Match: 21"
    assert expected in report


def test_validate_by_death_report_return_death_by_mean_correctly(dict):
    report = ByDeathMeanReport.generate(dict)
    expected = " Deaths By Mean:\n    MOD_ROCKET_SPLASH: 60\n    MOD_ROCKET: 37\n    MOD_TRIGGER_HURT: 14\n    MOD_RAILGUN: 9\n    MOD_SHOTGUN: 4\n    MOD_MACHINEGUN: 4\n    MOD_FALLING: 3"
    assert expected in report


def test_validate_by_death_report_return_correct_format(dict):
    report = ByDeathMeanReport.generate(dict)
    expected = """
--------------------------------------
 Match: 1
